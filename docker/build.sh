...
cp ../j-lawyer-server/j-lawyer-server-ear/target/j-lawyer-server.ear ./wildfly/
...
docker build -t="jlawyerorg/jlawyer-db:latest" -t="jlawyerorg/jlawyer-db:$jlversion" mariadb/.
