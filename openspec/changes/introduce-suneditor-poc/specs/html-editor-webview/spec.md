# Spec: HTML Editor WebView Component

## Overview

This specification defines the requirements for a WebView-based HTML editor component that embeds the SunEditor JavaScript library within JavaFX WebView for use in the j-lawyer Swing desktop client.

## Scope

This spec covers the proof-of-concept implementation of `WebViewHtmlEditorPanel`, a new HTML editor component that serves as a potential replacement for the SHEF-based `HtmlEditorPanel`.
...
- JavaFX libraries (javafx.web, javafx.swing)
- JavaScript HTML editor library (e.g., SunEditor, MIT license)
- EditorImplementation interface (j-lawyer-client)

**Note**: The specific JavaScript editor will be selected based on evaluation against requirements. SunEditor is the recommended choice based on feature completeness and license compatibility.

## Testing

### Unit Tests
- getText/setText with various HTML structures
- Insert with HTML entities
- Enable/disable state transitions
- Thread safety under concurrent access

### Integration Tests
- Full toolbar functionality (all required buttons)
- Text alignment (left, center, right)
- Paste from Word/LibreOffice with formatting preservation
- Undo/redo through multiple operations
- Resource cleanup
- Offline operation (no network requests)
- Base64 image embedding (paste, insert, drag-drop)

### Manual Tests
- Visual comparison with SHEF HtmlEditorPanel
- Cross-platform testing (Linux, Windows, macOS)
- Memory usage profiling
- Performance benchmarking (initialization time, typing latency)
- German spell checking (if browser configured)
- Word paste quality (complex documents with tables, fonts, colors)

## Success Metrics

- All scenarios pass
- No HTML corruption bugs observed in 100 open/save cycles
- No formatting loss in 100 Enter key presses with formatted content
- Memory usage ≤ 100MB per instance
- Initialization time ≤ 2 seconds
- Zero thread safety issues in stress testing
