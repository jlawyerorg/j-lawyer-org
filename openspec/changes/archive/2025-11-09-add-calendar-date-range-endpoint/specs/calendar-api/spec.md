...
## Cross-References
- Related to existing `CalendarService.searchReviews()` business logic
- Depends on existing `ArchiveFileReviewsBean` entity model
- Modifies `CasesEndpointV4` class in `/j-lawyer-server/j-lawyer-io/src/org/jlawyer/io/rest/v4/CasesEndpointV4.java`
- Reuses `RestfulDueDateV6` POJO from `/j-lawyer-server/j-lawyer-io/src/org/jlawyer/io/rest/v6/pojo/RestfulDueDateV6.java`
