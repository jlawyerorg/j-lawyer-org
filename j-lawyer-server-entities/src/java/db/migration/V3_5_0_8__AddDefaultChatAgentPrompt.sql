...
VALUES (
    ...
    '',
    'Mistral: Medium',
    CONCAT('api-key=BITTE EINGEBEN', CHAR(10), 'max-tokens=128000', CHAR(10), 'temperature=0.7'),
...
insert into server_settings(settingKey, settingValue) values('jlawyer.server.database.version','3.5.0.8') ON DUPLICATE KEY UPDATE settingValue = '3.5.0.8';
commit;
